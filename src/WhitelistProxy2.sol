...
contract WhitelistProxy2 {
    ...
    struct USDCStorage {
        ...
        bool initialized;
        mapping(address => uint256) balancesm;
    ...
    function initializeWhitelistProxy(address whitelister) external {
        require(!whitelistStorage().whitelistInitialized, "Already initialized.");
        ...
        whitelistStorage().whitelistInitialized = true;
    }

    function whitelistStorage() internal pure returns (USDCStorage storage ds) {
